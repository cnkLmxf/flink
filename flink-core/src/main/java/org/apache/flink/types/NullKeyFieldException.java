...
public class NullKeyFieldException extends RuntimeException {
    ...
    /**
     * Constructs an {@code NullKeyFieldException} with {@code null} as its error detail message.
     */
    ...
    /**
     * Constructs an {@code NullKeyFieldException} with a default message, referring to the field
     * number given in the {@code NullFieldException}.
     *
    ...
    /**
     * Constructs an {@code NullKeyFieldException} with a default message, referring to given field
     * number as the null key field.
     *
