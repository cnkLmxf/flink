 ...
 * <p>这扩展了 {@link java.io.InputStream} 的方法，
 * 用于访问流的 {@link #getPos() 当前位置} 和 {@link #seek(long) seek} 到所需位置。
 */
@Public
public abstract class FSDataInputStream extends InputStream {
     ...
     * 从文件开头寻找给定的偏移量。 下一个 read() 将来自该位置。 无法越过流的尽头寻找。
     *
