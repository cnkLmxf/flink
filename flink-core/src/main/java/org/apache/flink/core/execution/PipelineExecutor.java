...
public interface PipelineExecutor {
     ...
     * savepoint.
     * 根据提供的配置执行 {@link Pipeline} 并返回一个 {@link JobClient}，
     * 它允许与正在执行的作业进行交互，例如 取消它或采取一个保存点。
     *
     ...
     * call-site.
     * <b>注意：</b> 调用者负责管理返回的 {@link JobClient} 的生命周期。
     * 这意味着例如 {@code close()} 应该在调用站点显式调用。
     *
